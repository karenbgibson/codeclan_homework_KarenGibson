...
The p-value is 7% which is greater than our significance level of 5%. This means that we cannot reject our null hyposthesis in favour of our alternative hypothesis, i.e. we cannot say with confidence that more than 40% of the popualtion of the town are aware of the coffee shop. 
...
The p-value is 5.5% which is higher than our significance level of 5%. This means that we can reject our null hyposthesis in favour of alternative hyposthesis. We can say with confidence that on average the car part measurement is not equal to the specification width of 145mm.
