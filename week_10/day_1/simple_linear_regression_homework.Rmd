...
```
R^2 = 0.6475 means with estimated length as a predictor we can explian 64.75% of the variation in height.
...
The plot distributions look as we would hope and the line of best fit appears to fit our data points well. Our p-value is very small. All of these factors combined suggest that the relationship is statistically significant. 
